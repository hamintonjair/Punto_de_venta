    ...
    public partial class FormReporteMovimientosFILTROS : Form
    {
        ...
        private void mostrar()
        {
            try
            {
                ...
                da.SelectCommand.Parameters.AddWithValue("@fecha", Modulos.Inventarioss_Kardex.Inventarios_Menu.fecha);
                da.SelectCommand.Parameters.AddWithValue("@tipo", Modulos.Inventarioss_Kardex.Inventarios_Menu.Tipo_de_movimiento);
                da.SelectCommand.Parameters.AddWithValue("@Id_usuario", Modulos.Inventarioss_Kardex.Inventarios_Menu.id_usuario);
