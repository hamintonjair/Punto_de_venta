    ...
    public partial class Inventarios_Menu : Form
    {
        ...
        private void MOSTRAR_Inventarios_bajo_minimo()
        {
            try
            {
                ...
                ConexionDt.Tamaño_automatico_de_datatables.Multilinea(ref datalistadoInventarioBAJO);
            }
            catch (Exception ex)
            {
        ...
        private void mostrar_inventarios_todos()
        {
            try
            {
                ...
                ConexionDt.Tamaño_automatico_de_datatables.Multilinea(ref datalistadoInventariosReport);
        ...
        private void buscar_productos_movimientos()
        {
            try
            {
                ...
                ConexionDt.Tamaño_automatico_de_datatables.Multilinea(ref DATALISTADO_PRODUCTOS_Movimientos);
        ...
        private void buscar_MOVIMIENTOS_DE_KARDEX()
        {
            try
            {
                ...
                ConexionDt.Tamaño_automatico_de_datatables.Multilinea(ref DatalistadoMovimientos);
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message);
        ...
        private void buscar_MOVIMIENTOS_FILTROS_ACUMULADO()
        {
            try
            {
                ...
                ConexionDt.Tamaño_automatico_de_datatables.Multilinea(ref DatalistadoMovimientosACUMULADO_PRODUCTO);
        ...
        private void buscar_productos_vencidos()
        {
            try
            {
                ...
                ConexionDt.Tamaño_automatico_de_datatables.Multilinea(ref datalistadoVencimientos);
        ...
        private void txtBuscarVencimientos_TextChanged_1(object sender, EventArgs e)
        {
        ...
        private void txtbuscarMovimiento_TextChanged_1(object sender, EventArgs e)
        {
