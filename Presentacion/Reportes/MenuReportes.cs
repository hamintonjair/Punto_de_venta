...
namespace Punto_de_venta.Presentacion.Reportes
{
    public partial class MenuReportes : Form
    {
        ...
        private void MenuReportes_Load(object sender, EventArgs e)
        {
            ...
            PanelBienvenida.Dock = DockStyle.Left;
            lbAviso.Dock = DockStyle.Fill;
            lbAviso.Visible = true;
        }

        private void btnVentas_Click(object sender, EventArgs e)
        {
            lbAviso.Dock = DockStyle.None;
            lbAviso.Visible = false;
            panelVentas.Visible = true;
            panelVentas.Dock = DockStyle.Fill;
            PanelPorCobrarPagar.Dock = DockStyle.None;
            btnResumenVentas.ForeColor = Color.WhiteSmoke;          
            ...
            //Botones
            btnVentas.BackColor = Color.FromArgb(32, 106, 93); 
            btnVentas.ForeColor = Color.White;
            btnCobrar.BackColor = Color.Transparent;
        ...
        private void btnCobrar_Click(object sender, EventArgs e)
        {
            ...
            btnCobrar.BackColor = Color.FromArgb(32, 106, 93);
        ...
        private void BtnPagar_Click(object sender, EventArgs e)
        {
            ...
            BtnPagar.BackColor = Color.FromArgb(32, 106, 93);
            BtnProductos.ForeColor = Color.FromArgb(64, 64, 64);
            BtnProductos.BackColor = Color.Transparent;
        ...
        private void BtnProductos_Click(object sender, EventArgs e)
        {
            ...
            BtnProductos.BackColor = Color.FromArgb(32, 106, 93);
            //Paneles
        ...
        private void imprimir_inventarios_todos()
        {
            ...
            Reportes_de_Kardex_listo.Reportes_de_Inventario_Todos.ReportInventarios_Todos_todos rpt = new Reportes_de_Kardex_listo.Reportes_de_Inventario_Todos.ReportInventarios_Todos_todos();
            rpt.table1.DataSource = dt;
            rpt.DataSource = dt;
        ...
        private void mostrar_productos_vencidos()
        {
            ...
            Reportes_de_Kardex_listo.Reportes_de_Inventario_Todos.ReportePVencidos rpt = new Reportes_de_Kardex_listo.Reportes_de_Inventario_Todos.ReportePVencidos();
            rpt.table1.DataSource = dt;
            rpt.DataSource = dt;
            ReportViewer3.Report = rpt;
            ReportViewer3.RefreshReport();
        ...
        private void mostrarProdctosMinimo()
        {
            ...
            Reportes_de_Kardex_listo.Reportes_de_Inventario_Todos.ReportePbajomin rpt = new Reportes_de_Kardex_listo.Reportes_de_Inventario_Todos.ReportePbajomin();
            rpt.table1.DataSource = dt;
            rpt.DataSource = dt;
            ReportViewer3.Report = rpt;
            ReportViewer3.RefreshReport();
