...
namespace Punto_de_venta.Presentacion.Licencias_Membresias
{
    public partial class Membresias : Form
    {
        ...
        private void Membresias_Load(object sender, EventArgs e)
        {
            ...
            lblSerialPc.Text = Bases.Encriptar(lblSerialPc.Text);
            lblIDSERIAL.Text = Bases.Encriptar(MOS.Properties["SerialNumber"].Value.ToString());
        }
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            //        {
            //        }
            //        if (txtfecha_final_licencia_temporal.Value >= TXTFECHA_SISTEMA.Value && lblSerialPcLocal.Text == lblIDSERIAL)
            //        {
            //            MessageBox.Show("1");
