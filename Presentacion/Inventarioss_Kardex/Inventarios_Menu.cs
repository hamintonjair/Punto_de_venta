...
namespace Punto_de_venta.Presentacion.Inventarioss_Kardex
{
    public partial class Inventarios_Menu : Form
    {
        ...
        private void ToolStripMenuItem7_Click(object sender, EventArgs e)
        {
            ...
            Presentacion.Reportes.Reportes_de_Kardex_listo.Reportes_de_Inventario_Todos.FormReporteMovimientosFILTROS frm = new Presentacion.Reportes.Reportes_de_Kardex_listo.Reportes_de_Inventario_Todos.FormReporteMovimientosFILTROS();
            frm.ShowDialog();
        }
