...
namespace Punto_de_venta.Presentacion.Diseñador_de_Comprobantes
{
    public partial class Ticket : Form
    {
        ...
        private void Mostrar_formato_ticket()
        {
            try
            {
                ...
                da = new SqlDataAdapter("Mostrar_formato_ticket", ConexionDt.ConexionData.conectar);
                da.Fill(dt);
        ...
        private void Button4_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                cmd = new SqlCommand("editar_FORMATO_TICKET", ConexionDt.ConexionData.conectar);
